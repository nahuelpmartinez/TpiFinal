...
bool ArchivoClientes::registrarCliente(Cliente reg){
    FILE *pArchivoClientes = fopen(_nombreArchivo, "ab"); // Modo de apertura "append binary"
    if (pArchivoClientes == NULL){
        return false;
    }
...
//}
//bool ArchivoClientes::eliminarClientePorID(int id){
//    FILE *pCliente = fopen(_nombreArchivo, "rb+"); // Abrimos en modo de lectura y escritura
//    if (pCliente == NULL) {
//        cout << "No se pudo abrir el archivo." << endl;
//        return false;
//    }
...
//
//            // Movemos el puntero de archivo hacia atrás una posición para sobrescribir
//            fseek(pCliente, -sizeof(Cliente), SEEK_CUR);
//            fwrite(&reg, sizeof(Cliente), 1, pCliente); // Sobrescribimos el registro
//            fclose(pCliente);
//            cout << "Cliente con DNI " << id << " eliminado exitosamente." << endl;
//            return true;
//        }
//    }
...
//    fclose(pCliente);
//    cout << "Cliente con DNI " << id << " no encontrado." << endl;
//    return false; // No se encontró el cliente con el DNI dado
//}
//bool ArchivoClientes::modificarCliente(Cliente cli){
//     FILE *pCliente;
...
//        int escribio = fwrite(&cli, sizeof(Cliente), 1, pCliente);
//        fclose(pCliente);
//        return escribio;
//
//}
